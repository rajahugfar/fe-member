...
import SacasinoLandingPage from '@pages/SacasinoLandingPage'
import SacasinoHomePage from '@pages/SacasinoHomePage'
...
// Admin Root Redirect Component (redirect based on auth status)
  ...
  return (
    <>
      ...
      <Routes>
        ...
        <Route index element={<SacasinoHomePage />} />
        ...
        {/* Ranking Routes (no layout) */}
        <Route path="/ranking/:type?" element={<RankingPage />} />
        <Route path="/ranking/:type/:round" element={<RankingPage />} />

        {/* Invitation Route (no layout) */}
        <Route path="/invitation" element={<InvitationPage />} />
        
        {/* Promotions Route (no layout) */}
        <Route path="/promotions" element={<PromotionsPage />} />
        
        {/* Lucky Wheel Route (no layout) */}
        <Route path="/lucky-wheel" element={<LuckyWheelPage />} />

        {/* Auth Routes (Guest Only) - New Design */}
        <Route
          path="/login"
          element={
            <GuestRoute>
        ...
        <Route path="/member/register" element={<LoginPage />} />
        ...
        >
          ...
          <Route path="/admin/transfers/log" element={<TransferLog />} />
          ...
          <Route path="/admin/lottery/config" element={<LotteryConfigManagement />} />
          <Route path="/admin/lottery/tiers" element={<PayoutTierManagement />} />
          <Route path="/admin/lottery/daily" element={<StockMasterList />} />
          ...
          <Route path="/admin/lucky-wheel" element={<LuckyWheelManagement />} />
        </Route>
